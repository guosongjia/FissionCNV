...
flowchart TD
    ...
    subgraph OUT["Cohort outputs"]
        POPM["populationMatrix.py<br/>cross-sample reciprocal-overlap merge<br/>+ population-freq annotation"]
    ...
    class FAIDX,BWAIDX,MULTIQC,CK_ACC,CK_TGT,CK_ATG,CK_REF,MO_R,DL_MERGE,DL_GMERGE,DL_FILT,POPM cohort;
